...
export default function SearchResults(props){
    ...
    React.useEffect(() => {
        ...
        API.get(`/search/movie?language=en-US&include_adult=false&query=${props.search}`) // disini adalah script untuk output dari search
            .then(response => {
    ...
    return(
        ...
        >
            { results ?
                ...
                :
                <p className="bg-neutral-800 rounded drop-shadow-xl border-neutral-700 border-[1px] text-neutral-100 p-2">Nggak ketemu :|</p>
            }
        </motion.div>
    );
}