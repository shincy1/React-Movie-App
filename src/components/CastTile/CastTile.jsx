export default function CastTile(props){ // ini tambahan juga dari internet, isinya yaitu tokoh dan pemeran nya di film. komponen ini untuk modal movie (detail film)
    return(
